...
In <<table-feature-types, Table 9.1>> the spatial coordinates x and y typically refer to longitude and latitude but other horizontal coordinates [lime-background]#could# also be used (see sections 4 and 5.6).  
