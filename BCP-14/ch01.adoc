...
8. Conventions are provided to allow data-producers to describe the data they wish to produce, rather than attempting to prescribe what data they [aqua-background]#should# produce; consequently most CF conventions are [aqua-background]#optional#.
...
Every variable [aqua-background]#must# have associated metadata that allows identification of each such coordinate that is relevant.
