...
Tie point coordinate variables for both coordinate and auxiliary coordinate variables [aqua-background]#must# be defined as numeric data types and are not allowed to have missing values.
...
The **`interpolation_parameters`** attribute [aqua-background]#may# only be provided if allowed by the definition of the interpolation method.
