...
We [lime-background]#recommend# that the name of a multidimensional coordinate variable [aqua-background]#should not# match the name of any of its dimensions because that precludes supplying a coordinate variable for the dimension.
...
We [lime-background]#recommend# that this type of gridded data be stored using the compression scheme described in <<compression-by-gathering>>.
...
For this reason we strongly [lime-background]#recommend# against using a name for a scalar coordinate variable that matches the name of any dimension in the file.
