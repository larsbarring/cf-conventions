...
For such alternative coordinate variables, there are no mandatory attributes, but they [aqua-background]#may# have any of the attributes allowed for coordinate variables.
