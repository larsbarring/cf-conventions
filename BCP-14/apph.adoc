...
Each of the two element dimensions (time and vertical) [lime-background]#could# in principle be stored either contiguous or indexed, but these conventions support only one of the four possible choices.
...
Each of the two element dimensions (along a trajectory, within a profile) [lime-background]#could# in principle be stored either contiguous or indexed, but these conventions support only one of the four possible choices.
