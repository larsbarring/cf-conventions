...
This allows one to reserve space for additional profiles that [aqua-background]#may# be added at a later time, as discussed in section 9.6.
...
This allows one to reserve space for additional trajectories that [aqua-background]#may# be added at a later time, as discussed in section 9.6.
...
The data [lime-background]#can# be written as it arrives; if the flatsample dimension is the unlimited dimension, this allows data to be appended to the file.
...
This allows one to reserve space for additional stations that [aqua-background]#may# be added at a later time, as discussed in section 9.6.
In addition,
