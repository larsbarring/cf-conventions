...
__COARDS strongly [lime-background]#recommends# limiting the number of dimensions to four, but we wish to allow greater flexibility__.
...
They are allowed mainly for backwards-compatibility with existing datasets, and [aqua-background]#may# be [lime-background]#deprecated# in future versions of the standard.
====
