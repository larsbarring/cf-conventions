...
* The units **`level`**, **`layer`**, and **`sigma_level`** are [lime-background]#deprecated#.
...
* Use of the **`standard_name`** modifiers **`status_flag`** and **`number_of_observations`** is [lime-background]#deprecated#, and the corresponding **`standard_names`** are [aqua-background]#recommended# instead.
...
* The use of time coordinates in year 0 and reference date/times in year 0 to indicate climatological time is [lime-background]#deprecated#.
